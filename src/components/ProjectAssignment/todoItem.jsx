...
export default function TodoItem(props) {
  ...
  return (
    <>
    <div className={`${classes.content} ${deleteForm && classes.selected} relative w-full`}>
    ...
    {displayForm && <div className='flex items-center max-md:flex-col max-md:gap-3 gap-10 justify-center pb-4 mt-4'>
        ...
        <form className='flex items-center' onSubmit={handleSubmit((data)=>{
                  const todo={
                    id:id,
      ...
      }})} type='text'  className='inputStyle w-[100%] focus:border-gray-800'></input>
